...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            $error = "Gagal mengupdate admin: " . mysqli_error($conn);
        }
    }
}
?>
...
<head>
    ...
    <title>Edit Admin - CMS Sederhana</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="confirm_password" class="form-control" placeholder="Kosongkan jika tidak ingin mengubah password">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="full_name" class="form-control" value="<?php echo $admin_data['full_name']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>No. Telepon</label>
                                            <input type="text" name="phone" class="form-control" value="<?php echo $admin_data['phone']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea name="address" class="form-control" rows="3"><?php echo $admin_data['address']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Role</label>
                                            <select name="role" class="form-control" required>
                                                <option value="admin" <?php echo $admin_data['role'] === 'admin' ? 'selected' : ''; ?>>Admin</option>
                                                <option value="editor" <?php echo $admin_data['role'] === 'editor' ? 'selected' : ''; ?>>Editor</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Foto</label>
                                            <?php if ($admin_data['photo']): ?>
                                                <div class="mb-2">
                                                    <img src="../uploads/admins/<?php echo $admin_data['photo']; ?>" class="img-thumbnail" style="max-height: 100px;">
                                                </div>
                                            <?php endif; ?>
